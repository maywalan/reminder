...
const PRICE: Record<Currency, Record<Billing, string>> = {
  usd: { monthly: '$3.99', annual: '$24.99' },
  thb: { monthly: '฿132', annual: '฿827' },
};
const PERIOD: Record<Currency, Record<Billing, string>> = {
  usd: { monthly: 'per month', annual: 'per year · ≈$2.08/mo' },
  thb: { monthly: 'per month', annual: 'per year · ≈฿69/mo' },
};
const FINE_PRINT: Record<Currency, Record<Billing, string>> = {
  usd: {
    monthly: 'Billed $3.99 each month. Cancel anytime from account settings.',
    annual: 'Annual billed as one payment of $24.99/yr (≈ $2.08/mo). Cancel anytime from account settings.',
  },
  thb: {
    monthly: 'Billed ฿132 each month. Converted at ≈ ฿33.10/$1 — App Store price may round. Cancel anytime.',
    annual: 'Annual billed as one payment of ฿827/yr (≈ ฿69/mo). Converted at ≈ ฿33.10/$1 — App Store price may round. Cancel anytime.',
  },
};
